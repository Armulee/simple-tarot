...
import { Share2, Users, Megaphone, Zap, Gift, Check, Star } from "lucide-react"
        ...
        <section className='relative'>
            <div className='w-full'>
                ...
                <Accordion className='space-y-4'>
                    ...
                    {/* Social Follow */}
                    <AccordionItem className='group relative overflow-hidden rounded-2xl border border-purple-500/30 bg-gradient-to-r from-purple-400/15 via-violet-500/15 to-indigo-500/15 px-4 py-2 hover:from-purple-400/20 hover:via-violet-500/20 hover:to-indigo-500/20 transition-all duration-300'>
                        <AccordionTrigger className='px-2 py-4 hover:no-underline'>
                            <div className='flex items-center gap-4 w-full'>
                                <div className='relative'>
                                    <span
                                        className={`h-12 w-12 rounded-full border flex items-center justify-center group-hover:scale-110 transition-transform duration-300 ${
                                            allSocialClaimed
                                                ...
                                                : "bg-gradient-to-r from-purple-500/30 via-violet-500/30 to-indigo-500/30 border-purple-500/40 text-purple-100"
                                        }`}
                                    >
                                        {allSocialClaimed ? (
                                ...
                                <span className='text-xs px-3 py-1.5 rounded-full bg-gradient-to-r from-purple-400/30 via-violet-500/30 to-indigo-500/30 border border-purple-500/40 text-purple-200 flex items-center gap-1.5 font-medium'>
                                    <Star
                                        className='w-3.5 h-3.5'
                                        fill='currentColor'
                                    />
                        ...
                        <AccordionContent className='px-2 pb-4'>
                            <div className='space-y-4 p-6 rounded-xl bg-gradient-to-br from-purple-400/10 via-violet-500/10 to-indigo-500/10 border border-purple-500/30 relative overflow-hidden'>
                                ...
                                <div className='pointer-events-none absolute -bottom-20 -left-20 h-48 w-48 rounded-full bg-violet-400/15 blur-3xl animate-pulse delay-1000' />
