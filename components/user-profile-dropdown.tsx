    ...
    return (
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent
                    align='end'
                    className='w-56 bg-card border border-border/50 overflow-visible shadow-lg z-[9999]'
                    sideOffset={5}
                >
                    ...
                    <DropdownMenuGroup>
                        ...
                        <DropdownMenuSub>
                            ...
                            <DropdownMenuSubContent 
                                className='w-44 bg-card border border-border/50 overflow-visible shadow-lg z-[10000]'
                                sideOffset={-2}
                                alignOffset={-2}
                            >
                                {themes.map((theme) => (
