    ...
    return (
        <div className='grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4'>
            {Object.entries(stats).map(([key, stat]) => {
                ...
                let cardClassName =
                    "p-4 sm:p-5 bg-gradient-to-br from-white/10 via-white/5 to-transparent border-white/20 backdrop-blur-xl transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-accent/20 hover:border-accent/40"
                let iconAura = ""
                ...
                if (status === "exalted") {
                    ...
                    cardClassName =
                        "p-4 sm:p-5 bg-gradient-to-br from-yellow-500/30 via-amber-500/20 to-yellow-500/10 border-yellow-500/50 backdrop-blur-xl shadow-[0_0_25px_rgba(234,179,8,0.4)] hover:shadow-[0_0_35px_rgba(234,179,8,0.6)] hover:scale-105 transition-all duration-500"
                    iconAura =
                        "shadow-[0_0_15px_rgba(255,255,255,0.8)] animate-pulse"
                    ...
                    // Own Sign Styling
                    cardClassName =
                        "p-4 sm:p-5 bg-gradient-to-br from-blue-500/30 via-indigo-500/20 to-blue-500/10 border-blue-500/50 backdrop-blur-xl shadow-[0_0_25px_rgba(59,130,246,0.4)] hover:shadow-[0_0_35px_rgba(59,130,246,0.6)] hover:scale-105 transition-all duration-500"
                    ...
                    statusLabel = (
                        <span className='text-[10px] uppercase tracking-wider font-bold text-blue-400 flex items-center gap-1 mb-1 ml-auto'>
                            <ShieldCheck className='w-3 h-3 fill-blue-400' />{" "}
                    ...
                    cardClassName =
                        "p-4 sm:p-5 bg-gradient-to-br from-gray-900/50 to-black/50 border-gray-700/40 backdrop-blur-xl hover:scale-105 transition-all duration-500"
                    ...
                    // Normal case
                    cardClassName =
                        "p-4 sm:p-5 bg-gradient-to-br from-white/10 via-white/5 to-transparent border-white/20 backdrop-blur-xl hover:scale-105 hover:shadow-xl hover:shadow-accent/10 hover:border-accent/30 transition-all duration-500"
                    statusLabel = (
                        ...
                        <div className='flex flex-col gap-3 relative z-10'>
                            <div className='flex justify-between items-start'>
                                <div className='flex items-center gap-3'>
                                    <div
                                        className={`p-3 rounded-xl ${STAT_COLORS[k]} ${iconAura} relative overflow-hidden shrink-0 transition-transform duration-300 group-hover:scale-110`}
                                    >
                                    ...
                                    <div className='flex flex-col'>
                                        <h3
                                            className={`font-bold capitalize text-base sm:text-lg ${labelColor} leading-tight`}
                                        >
                                            {archetype}
                                        </h3>
                                        <span className='text-[10px] sm:text-xs opacity-70 font-medium flex items-center gap-1.5 mt-0.5'>
                                            <PlanetIcon className='w-3 h-3' />{" "}
                                            {planetName}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div className='mt-2'>
                                <div className='flex justify-between items-end mb-2'>
                                    <span
                                        className={`font-bold text-lg sm:text-xl leading-none ${status === "exalted" ? "text-yellow-400" : status === "own_sign" ? "text-blue-300" : "text-white"} transition-colors`}
                                    >
                                        {displayValue}%
                                    </span>
                                    {statusLabel}
