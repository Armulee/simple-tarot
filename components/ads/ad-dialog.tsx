...
export default function AdDialog({
    ...
    return (
        <Dialog open={open && mounted} onOpenChange={onOpenChange}>
            <DialogContent className='p-0 bg-transparent border-0 shadow-none'>
                <div className='relative w-full max-w-lg mx-auto'>
                    {/* Container with cosmic effects */}
                    <div className='relative overflow-hidden bg-gradient-to-br from-background/95 via-background/90 to-background/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl'>
                        {/* Cosmic Stars Background inside content */}
                        ...
                        <div
                            className='absolute top-1/2 left-1/2 w-32 h-32 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-full blur-2xl -translate-x-16 -translate-y-16 animate-pulse'
                            style={{ animationDelay: "1s" }}
                        />

                        {/* Sparkles */}
                        <div
                            className='absolute top-4 left-4 w-2 h-2 bg-white rounded-full opacity-60 animate-ping'
                            style={{ animationDelay: "0.5s" }}
                        />
                        <div
                            className='absolute top-8 right-8 w-1 h-1 bg-blue-400 rounded-full opacity-80 animate-ping'
                            style={{ animationDelay: "1.5s" }}
                        />
                        <div
                            className='absolute bottom-6 left-8 w-1.5 h-1.5 bg-purple-400 rounded-full opacity-70 animate-ping'
                        ...
                        <div className='relative z-10 p-8 pb-6'>
                            <div className='text-center space-y-4'>
                                <div className='flex items-center justify-center space-x-3'>
                                    ...
                                    <DialogTitle className='font-serif font-bold text-2xl bg-gradient-to-r from-primary via-white to-accent bg-clip-text text-transparent'>
                                        {t("title")}
                                    </DialogTitle>
                                    <Sparkles
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <ul className='text-xs text-muted-foreground space-y-1'>
                                            ...
                                            <li className='flex items-center space-x-2'>
                                                ...
                                                <span>
                                                    {t(
                                                        "benefits.detailedInterpretation"
                                                    )}
                                                </span>
                                            </li>
                                            <li className='flex items-center space-x-2'>
