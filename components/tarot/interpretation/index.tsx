...
function DynamicInterpretation() {
...
export default function Interpretation(props?: StaticReadingProps) {
    if (props?.readingId) {
        return <StaticInterpretation {...props} />
    }
    return <DynamicInterpretation />
}
