            ...
            {currentStep === "interpretation" && (
                <div className='space-y-8'>
                    ...
                    <div className='flex flex-col lg:flex-row lg:items-start lg:gap-12'>
                        ...
                        {/* Right Side - Interpretation and Actions */}
                        <div className='lg:flex-1 lg:max-w-lg'>
                            <Card className='p-6 bg-card/10 backdrop-blur-sm border-border/20 card-glow'>
                                <div className='space-y-6'>
                                    ...
                                    {/* Action Buttons - Under Interpretation */}
                    ...
                    {/* Follow-up Question - Centered Below */}
                    {(interpretation || finish || error) && !error && (
                        <div className='max-w-xl mx-auto border-t border-border/20 pt-8'>
                            <QuestionInput
                                followUp={true}
