...
type CharacterComposerButtonProps = {
    /** Insert a mention for the chosen character into the composer input. */
 ...
 * the upgrade paywall. Self-contained: owns the character list, the add form,
 * and the paywall dialog.
 */
