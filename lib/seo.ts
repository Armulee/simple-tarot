...
import { getStructuredDataForPage } from '@/app/structured-data'

// SEO Configuration for Asking Fate AI Tarot Reading Website
export const seoConfig = {
  siteName: 'Asking Fate',
  siteUrl: 'https://askingfate.com',
  description: 'Get free AI-powered tarot card readings and spiritual guidance. Ask questions about your destiny and receive personalized insights from our advanced AI tarot system.',
  keywords: [
    'AI tarot reading',
    'free tarot cards',
    'spiritual guidance',
...
export function generatePageMetadata({
  ...
  const fullTitle = title.includes('Asking Fate') ? title : `${title} | Asking Fate`
...
export const pageMetadata = {
  home: generatePageMetadata({
    ...
    keywords: ['AI tarot reading', 'free tarot cards', 'spiritual guidance', 'destiny questions'],
    url: '/',
  }),
  ...
  reading: generatePageMetadata({
    ...
    keywords: ['tarot card reading', 'AI tarot reading', 'free tarot reading', 'tarot card interpretation'],
    url: '/reading',
  }),
  ...
  about: generatePageMetadata({
    ...
    keywords: ['AI tarot technology', 'tarot reading history', 'spiritual guidance AI', 'mystical traditions'],
    url: '/about',
  }),
  ...
  contact: generatePageMetadata({
    ...
    keywords: ['tarot reading support', 'AI tarot help', 'spiritual guidance contact', 'tarot reading questions'],
    url: '/contact',
  }),
  ...
  privacy: generatePageMetadata({
    ...
    keywords: ['privacy policy', 'data protection', 'AI tarot privacy', 'personal information security'],
    url: '/privacy-policy',
  }),
  ...
  terms: generatePageMetadata({
    ...
    keywords: ['terms of service', 'terms and conditions', 'AI tarot terms', 'tarot reading terms'],
