...
- headline: a short, punchy verdict line (2-10 words) that DIRECTLY answers the user's question. Plain language. This is the ONE place a planet name and an astrological term ARE allowed if the user asked about that planet — e.g. "Jupiter exalted from May 2026" or "Saturn enters Aries 24 April 2028". Stay concrete: if the question is a "when", give a date or month/year. If it is a "what sign", name the sign and how long it stays. The date MUST be in the FUTURE relative to "Current date and time" shown above — never quote a past event as the answer.
