...
export async function generateMetadata(): Promise<Metadata> {
    const t = await getTranslations("Meta.TermsOfService")
    return {
        title: t("title"),
        ...
        <div className='min-h-screen relative overflow-hidden'>
            <main className='relative z-10 max-w-4xl mx-auto px-6 py-16'>
                <div className='space-y-8'>
                    ...
                    <div className='px-4 prose prose-invert max-w-none space-y-8'>
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                By accessing, browsing, or using our Service,
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                changes by posting the updated Terms on our
                                website and updating the &quot;Last
                                updated&quot; date. Your continued use of the
                                Service after such modifications constitutes
                        ...
                        <section className='space-y-4'>
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                <li>
                                    • AI-generated tarot card interpretations
                                    and readings
                                </li>
                                <li>
                                    • Multiple reading types and card spreads
                                </li>
                                <li>
                                    • Personalized spiritual guidance and
                                    insights
                                </li>
                                <li>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                Our Service is designed for entertainment,
                                spiritual guidance, and personal reflection
                                purposes. It is not intended to replace
                                professional advice in any field, including but
                                not limited to medical, legal, financial, or
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                Service. If you are between 13 and 18 years of
                                age, you must have parental or guardian consent
                                to use our Service. We do not knowingly collect
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                ...
                                <li>
                                    • Maintain and update your information to
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                your account at any time, with or without
                                notice, for any reason, including violation of
                                these Terms or fraudulent, abusive, or illegal
                                activity.
                            </p>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                <li>
                                    ...
                                    or to solicit others to perform unlawful
                                    acts
                                </li>
                                <li>
                                    • Violate any international, federal,
                                    provincial, or state regulations, rules,
                                    laws, or local ordinances
                                </li>
                                <li>
                                    • Infringe upon or violate our intellectual
                                    property rights or the intellectual property
                                    rights of others
                                </li>
                                <li>
                                    • Harass, abuse, insult, harm, defame,
                                ...
                                <li>
                                    • Upload or transmit viruses or any other
                                    type of malicious code
                                </li>
                                <li>
                                    • Spam, phish, pharm, pretext, spider,
                                    crawl, or scrape
                                </li>
                                <li>
                                    • Use the Service for any obscene or immoral
                                    purpose
                                </li>
                                <li>
                                    • Interfere with or circumvent the security
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                When using our Service, you agree not to submit
                                content that:
                            </p>
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                <li>
                                ...
                                <li>
                                    • Contains hate speech or promotes
                                    discrimination
                                </li>
                                <li>
                                    • Is sexually explicit or contains adult
                                    content
                                </li>
                                <li>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                (&quot;User Content&quot;). By submitting User
                                Content, you grant us a worldwide,
                                non-exclusive, royalty-free license to use,
                                reproduce, modify, adapt, publish, translate,
                                and distribute such content in connection with
                                the Service.
                            </p>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                Our Service may contain content from third
                                parties, including but not limited to tarot card
                                imagery, interpretations, and spiritual
                                guidance. Such content is protected by copyright
                                and other intellectual property laws and is used
                                with permission or under appropriate licenses.
                            </p>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                any kind, either express or implied. We disclaim
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                ...
                                <li>
                                    ...
                                    reliability, or completeness of content
                                </li>
                                <li>
                                    • Warranties regarding the availability,
                                    security, or performance of the Service
                                </li>
                                <li>
                                    • Warranties regarding the results obtained
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                Tarot readings provided through our Service are
                                for entertainment and spiritual guidance
                                purposes only. They should not be used as a
                                substitute for professional advice in any field,
                                including:
                            </p>
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                <li>
                                ...
                                <li>
                                    • Life coaching or decision-making guidance
                                </li>
                            </ul>
                            <p className='text-muted-foreground leading-relaxed'>
                                We are not responsible for any decisions made
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                To the maximum extent permitted by law, Asking
                                Fate shall not be liable for any indirect,
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                Our total liability to you for any damages
                                arising from or related to these Terms or the
                                Service shall not exceed the amount you paid us
                                for the Service in the 12 months preceding the
                                claim.
                            </p>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                and use of personal information in connection
                                with the Service is described in our Privacy
                                Policy, which is incorporated into these Terms
                                by reference.
                            </p>
                            <p className='text-muted-foreground leading-relaxed'>
                                By using our Service, you consent to the
                                collection and use of information as described
                                in our Privacy Policy. We implement appropriate
                                security measures to protect your personal
                                information, but we cannot guarantee absolute
                                security.
                            </p>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                will cease immediately. If you wish to terminate
                                your account, you may simply discontinue using
                                the Service or contact us to request account
                                deletion.
                            </p>
                            <p className='text-muted-foreground leading-relaxed'>
                                All provisions of these Terms which by their
                                nature should survive termination shall survive
                                termination, including ownership provisions,
                                warranty disclaimers, indemnity, and limitations
                                of liability.
                            </p>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                the laws of Thailand, without regard to its
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                of the Thai Arbitration Institute. The
                                arbitration shall be conducted in Bangkok,
                                Thailand, in the English language.
                            </p>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                We may assign or transfer these Terms, in whole
                                or in part, without restriction. You may not
                                assign or transfer these Terms without our prior
                                written consent.
                            </p>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                in performance under these Terms which is due to
                                fire, flood, earthquake, elements of nature, or
                                acts of God, acts of war, terrorism, strikes,
                                labor disputes, or any other cause which is
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                We will respond to your inquiry within 5
                                business days.
                            </p>
                        </section>
                    </div>
