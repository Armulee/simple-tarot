...
export default function PurchasePage() {
    ...
    const initialSelection = useMemo<SelectionKey | null>(() => {
        ...
        if (pack === "pack-1" || pack === "pack-3" || pack === "pack-5")
            return pack
    ...
    const selectedPack = useMemo<SelectedPack | null>(() => {
        ...
        if (
            selectedKey === "infinity-month" ||
            selectedKey === "infinity-year"
        ) {
    ...
    const planPricing = useMemo(() => {
        ...
        if (
            ...
            return {
                label: `${pack.stars} stars`,
                stars: pack.stars,
                basePrice: base,
                discount: round2(base - pack.priceUsd),
                total: pack.priceUsd,
            }
        }
        return null
        ...
        <section className='relative z-10 max-w-3xl mx-auto px-6 py-10 space-y-6'>
            ...
            <div className='text-center space-y-2'>
                ...
                <p className='text-sm text-muted-foreground'>
                    Secure and instant delivery after payment.
                </p>
            </div>
                    ...
                    {[
                        {
                            ...
                            details:
                                "Auto-renewing monthly plan with unlimited stars. Cancel anytime.",
                        },
                        {
                            ...
                            icon: <span className='text-2xl'>∞</span>,
                            details:
                                "Billed yearly, best value. Unlimited stars, cancel renewal anytime.",
                        },
                        {
                            ...
                            icon: <span className='text-2xl'>∞</span>,
                            details:
                                "One-time purchase for 30 days of unlimited usage. No auto-renew.",
                        },
                        {
                            ...
                            icon: <span className='text-2xl'>∞</span>,
                            details:
                                "One-time purchase for 365 days of unlimited usage. No auto-renew.",
                        },
                        {
                            ...
                            details:
                                "One-time pack. Instant delivery after payment.",
                        },
                        {
                            ...
                            details:
                                "Better value pack with bonus stars included. Instant delivery.",
                        },
                        {
                            ...
                            details:
                                "Best value pack with the biggest bonus. Instant delivery.",
                        },
                    ].map((card) => {
                        const selected = selectedKey === card.key
                        if (showOnlySelected && selectedKey && !selected)
                            return null
                        return (
                            <button
                                key={card.key}
                                ...
                                className={cn(
                                    ...
                                    selected
                                        ? "border-white/50 ring-2 ring-white/25 shadow-lg bg-white/10"
                                        : "border-border/20 hover:border-white/30"
                                )}
                            >
                    ...
                    <div className='mt-2 flex justify-center'>
                        ...
                        >
                            {showOnlySelected ? (
                                ...
                                <>
                                    <ChevronUp className='w-4 h-4 mr-1' /> Show
                                    less
                                </>
                            )}
                        </Button>
                ...
                <div className='space-y-4'>
                    ...
                    {planPricing && (
                        <div className='space-y-1'>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <span className='font-semibold'>
                                    ${planPricing.basePrice.toFixed(2)}
                                </span>
                            </div>
                            <div className='flex items-center justify-between'>
                                <span className='text-sm text-white/80'>
                                ...
                                <span className='font-semibold'>
                                    -${planPricing.discount.toFixed(2)}
                                </span>
                            </div>
                        </div>
                    )}
                    {!isUnlimited && selectedPack && (
                        <div className='flex items-center justify-between'>
                            ...
                            <span className='font-bold text-xl'>
                                ${(selectedPack as Pack).priceUsd.toFixed(2)}
                            </span>
                        </div>
                    )}
                    ...
                    {isUnlimited && (
                        <div className='flex items-center gap-2 text-amber-200 text-sm'>
                            ...
                            <span>
                                Unlimited plans checkout is coming soon.
                            </span>
                        </div>
                    )}
                </div>
            ...
            <Card className='p-6 rounded-xl bg-card/10 border-border/20 space-y-4'>
                ...
                <div className='text-xs text-muted-foreground text-center'>
                    Payments are handled securely. Stars deliver instantly after
                    payment.
                </div>
            </Card>
        </section>
