...
export async function generateMetadata(): Promise<Metadata> {
    const t = await getTranslations("Meta.PrivacyPolicy")
    return {
        title: t("title"),
                    ...
                    <div className='px-4 prose prose-invert max-w-none space-y-8'>
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                with the terms of this Privacy Policy, please do
                        ...
                        <section className='space-y-4'>
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                ...
                                <li>
                                    • Tarot reading data (questions asked, cards
                                    selected, interpretations received)
                                </li>
                            </ul>
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                ...
                                <li>
                                    • Marketing partners (referral information)
                                </li>
                            </ul>
                        </section>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                do so by law or in response to valid legal
                                processes, such as:
                            </p>
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                as part of the transaction. We will notify you
                        ...
                        <section className='space-y-4'>
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                ...
                                <li>
                                    • Employee training on data protection best
                                    practices
                                </li>
                                <li>
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                as necessary to provide our Service and fulfill
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                of your personal information in a structured,
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                information through your account settings or by
                                contacting us.
                            </p>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                personal information, subject to certain legal
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                communications at any time using the unsubscribe
                        ...
                        <section className='space-y-4'>
                            ...
                            <ul className='space-y-2 text-muted-foreground ml-4'>
                                <li>
                                    • Standard contractual clauses approved by
                        ...
                        <section className='space-y-4'>
                            ...
                            <p className='text-muted-foreground leading-relaxed'>
                                ...
                                recommend parental guidance and supervision when
                                using our Service.
                            </p>
                        </section>
